...
import { Phone, User, Pencil, Check, X, Search, MapPin } from "lucide-react";
...
export function ContactList({ daerahList, updateContact }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-4 text-sm text-muted-foreground">
        <span>{daerahList.length} daerah</span>
            ...
            <CardContent className="p-4 space-y-3">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-bold text-gray-900">{d.nama}</h3>
                </div>
                {editingId !== d.id && (
